...
/**
 * Definition for std_msgs/UInt64MultiArray
 *
 ...
 */
@MessageMetadata(
        name = UInt64MultiArrayMessage.NAME,
        fields = {"layout", "data"},
        md5sum = "6088f127afb1d6c72927aa1247e945af")
public class UInt64MultiArrayMessage implements Message {

    static final String NAME = "std_msgs/UInt64MultiArray";
    ...
    public UInt64MultiArrayMessage withLayout(MultiArrayLayoutMessage layout) {
        this.layout = layout;
        return this;
    }

    public UInt64MultiArrayMessage withData(long... data) {
        this.data = data;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof UInt64MultiArrayMessage other)
