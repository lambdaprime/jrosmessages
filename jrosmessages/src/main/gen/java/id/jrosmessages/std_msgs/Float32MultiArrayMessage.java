...
/**
 * Definition for std_msgs/Float32MultiArray
 *
 ...
 */
@MessageMetadata(
        name = Float32MultiArrayMessage.NAME,
        fields = {"layout", "data"},
        md5sum = "6a40e0ffa6a17a503ac3f8616991b1f6")
public class Float32MultiArrayMessage implements Message {

    static final String NAME = "std_msgs/Float32MultiArray";
    ...
    public Float32MultiArrayMessage withLayout(MultiArrayLayoutMessage layout) {
        this.layout = layout;
        return this;
    }

    public Float32MultiArrayMessage withData(float... data) {
        this.data = data;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof Float32MultiArrayMessage other)
