...
/**
 * Definition for std_msgs/Int8MultiArray
 *
 ...
 */
@MessageMetadata(
        name = Int8MultiArrayMessage.NAME,
        fields = {"layout", "data"},
        md5sum = "d7c1af35a1b4781bbe79e03dd94b7c13")
public class Int8MultiArrayMessage implements Message {

    static final String NAME = "std_msgs/Int8MultiArray";
    ...
    public Int8MultiArrayMessage withLayout(MultiArrayLayoutMessage layout) {
        this.layout = layout;
        return this;
    }

    public Int8MultiArrayMessage withData(byte... data) {
        this.data = data;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof Int8MultiArrayMessage other)
