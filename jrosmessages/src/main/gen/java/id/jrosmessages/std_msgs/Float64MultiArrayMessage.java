...
/**
 * Definition for std_msgs/Float64MultiArray
 *
 ...
 */
@MessageMetadata(
        name = Float64MultiArrayMessage.NAME,
        fields = {"layout", "data"},
        md5sum = "4b7d974086d4060e7db4613a7e6c3ba4")
public class Float64MultiArrayMessage implements Message {

    static final String NAME = "std_msgs/Float64MultiArray";
    ...
    public Float64MultiArrayMessage withLayout(MultiArrayLayoutMessage layout) {
        this.layout = layout;
        return this;
    }

    public Float64MultiArrayMessage withData(double... data) {
        this.data = data;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof Float64MultiArrayMessage other)
