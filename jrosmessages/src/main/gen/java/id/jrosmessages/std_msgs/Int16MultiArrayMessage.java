...
/**
 * Definition for std_msgs/Int16MultiArray
 *
 ...
 */
@MessageMetadata(
        name = Int16MultiArrayMessage.NAME,
        fields = {"layout", "data"},
        md5sum = "d9338d7f523fcb692fae9d0a0e9f067c")
public class Int16MultiArrayMessage implements Message {

    static final String NAME = "std_msgs/Int16MultiArray";
    ...
    public Int16MultiArrayMessage withLayout(MultiArrayLayoutMessage layout) {
        this.layout = layout;
        return this;
    }

    public Int16MultiArrayMessage withData(short... data) {
        this.data = data;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof Int16MultiArrayMessage other)
